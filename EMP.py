...
def recognize_emotion():
    ...
    songNum = random.randint(1,15)
    mp = Dispatch("WMPlayer.OCX")
    if pred == 0:
        tune = mp.newMedia("music/angry/{}.mp3".format(songNum))
        print("Angry song is playing.")
    elif pred == 1:
        tune = mp.newMedia("music/happy/{}.mp3".format(songNum))
        print("Happy song is playing.")
    elif pred == 2:
        tune = mp.newMedia("music/sad/{}.mp3".format(songNum))
        print("Sad song is playing.")
    elif pred == 3:
        tune = mp.newMedia("music/neutral/{}.mp3".format(songNum))
        print("Neutral song is playing.")
    elif pred == 4:
        tune = mp.newMedia("music/surprise/{}.mp3".format(songNum))
